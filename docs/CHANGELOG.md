...
- **Discord on profiles (opt-in)**: a new Settings toggle "Show Discord on leaderboard" (default OFF) puts "Discord: @displayname" on your leaderboard detail panel, right above the Mod line.
