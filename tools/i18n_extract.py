...
SITES = [
    ...
    # Player Cards consent rows (c4): PlayerCardsUI.SettingsRow(parent, name,
    # onClick, DESC, descH) hands the hint to its own CreateText as a
    # variable, so the literal is visible only at the call sites.
    (re.compile(r'(?<![.\w])SettingsRow\s*\('), (3,)),
