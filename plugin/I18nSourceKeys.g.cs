...
namespace CompetitiveRounds
{
    internal static class I18nSourceKeys
    {
        internal static readonly string[] Keys =
        {
            ...
            "5-0 wins carrying this card (all players, casual + ranked)",
            "5-0s Given / Taken",
            ...
            "<color=#FFD94D>{0}g</color> <color=#AAA>earned across</color> <color=#FFD94D>{1}</color> <color=#AAA>purchases - {2} distinct items sold</color>",
            ...
            "E (hold, between rounds) - dance emote wheel",
