// AUTO-GENERATED by tools/i18n_extract.py — do not edit.
// The extracted translatable source set; I18n's pack
// allowlist (server packs may only override these keys).
namespace CompetitiveRounds
{
    internal static class I18nSourceKeys
    {
        internal static readonly string[] Keys =
        {
            ...
            "   -   SUDDEN DEATH: everyone else cannot damage each other",
            "   -   {0}-CARD DRAW",
            "  (last: {0})",
            "  ({0} in queue)",
            "  <color=#66AACC>{0:F1}% of players have this</color>",
            "  <color=#7FDBFF>|</color>  <color=#AAAAAA>{0} online</color>",
            "  <color=#888>(no cards recorded)</color>",
            "  <color=#888>(page {0}/{1}, {2} total)</color>",
            "  <color={0}>Game streak: {1}L</color>",
            "  <color={0}>Game streak: {1}W</color>",
            "  <color={0}>Series streak: {1}L</color>",
            "  <color={0}>Series streak: {1}W</color>",
            "  <color={0}>Streak: {1}L</color>",
            "  <color={0}>Streak: {1}W</color>",
            "  Best: {0}W",
            "  Dmg/game: {0:F0}",
            "  In room with {0}",
            "  Top 3: {0:F0}%  Kills/game: {1:F1}  Avg place: {2:F1}{3}",
            "  [Opponent Ready]",
            "  vs {0}:  <color={1}>{2}W-{3}L lifetime</color>{4}",
            "  vs {0}:  First time playing!",
            "  {0}  <color=#888>{1} their side</color>  <color=#666>{2}</color>",
            ...
            "(loading...)",
            "(menu only)",
            "(no log content read from: {0})",
            "(no previous-session log yet — gets written by the mod when ROUNDS is closed cleanly, so on first ever launch this is empty)\n\nExpected path: {0}",
            "(partial)",
            "(placements {0})",
            "(self)",
            "* <color=#C8C8C8>2nd</color> - {0}g / {1} XP / Runner Up role",
            "* <color=#D4894A>3rd</color> - {0}g / {1} XP / 3rd Place role (loser of LB final)",
            "* <color=#FFE580>1st</color> - {0}g / {1} XP / Winner role",
            "+ Add",
            "+ {0} more artists",
            "+{0} gold",
            "+{0} more",
            "+{0} more bets",
            "+{0} more lines",
            "- Buy one for {0} gold or {1} shards, up to {2} paid packs a day.",
            "- Buy one for {0} gold or {1} shards. No daily limit on this account.",
            "- One free pack every day (resets at midnight UTC). Claim it on the Open Packs page or with /daily in Discord.",
            "- Ranked wins: every ranked 1v1 series you win rolls a 20% chance of a pack (a 2-0 sweep: 100%). 2v2, 1v2 and FFA wins roll 10% (a sweep: 50%). Earned packs wait here until you open them.",
            "0 in queue",
            "100g each - the hardest pay 300g, 500g or 1000g",
            "1V1 BETTING WINDOW",
            "1V2: ONE AGAINST TWO",
            "1v1 Podium",
            "1v1 record: series {0}W-{1}L ({2}%)   games {3}W-{4}L",
            "1v1: your opponent can take the game under the disconnect rules; the series may stay open.",
            "1v2 - How It Works",
            "1v2 - UNRATED",
            "1v2 Series: Duo {0} - {1} Solo",
            "1v2 Series: You {0} - {1} Duo",
            "1v2 as duo",
            "1v2 as solo",
            "1v2 lobby never filled — returning to menu. Requeue when ready.",
            "1v2 match found, but you're in a game — removed from the 1v2 queue.",
            "1v2 series complete: {0}",
            "1v2 series: {0}",
            "1v2 — Solo vs Duo",
            "1v2: leaving ends your sitting; there is no automatic forfeit.",
            "2V2: ONE SERIES, TWO TEAMS",
            "2v2 (opposite teams)",
            "2v2 - How It Works",
            "2v2 Podium",
            "2v2 QUEUE",
            ...
            "2v2: the series settles for the other team only if they have already won a game and this game has at least 2 total points; otherwise it pauses as incomplete.",
            "3/3 ready! Joining 1v2 — you are on the DUO...",
            "3/3 ready! Joining 1v2 — you are the SOLO...",
            "30 FPS",
            "30-second previews - they stop on their own",
            "3rd Place",
            "4 players",
            "4/4 ready! Joining 2v2...",
            "400 FPS",
            "5-0 Sweeps",
            "5-0 someone with Chase",
            "5-0 someone with Glass Cannon",
            "5-0 someone with Mayhem",
            "5-0 someone with Sneaky",
            "5-0s Given / Taken",
            "50 ACHIEVEMENTS BY PAYOUT",
            "60 FPS",
            "7-day deadline",
            "7-track Metal / Phonk album",
            "8-PLAYER DOUBLE-ELIMINATION FLOW",
            "< BACK",
            "< Newer",
            "< Older",
            "< Prev",
            "<b>2v2 Leaderboard</b>",
            "<b>2v2 Leaderboard</b>  <color=#888>({0} ranked)</color>",
            "<b>2v2 Leaderboard</b>  <color=#888>— no completed series yet</color>",
            "<b>2v2 Ranked</b>  <color=#888>(own Glicko, friendly fire on, BO3)</color>",
            "<b>2v2 Ranked</b>  <color={0}>({1} searching)</color>",
            "<b><color=#88AAFF>Duo Leaderboard</color></b>  <color=#888>(unranked)</color>",
            "<b><color=#999999>Start (saving...)</color></b>",
            "<b><color=#FF6688>* Live 1v2 Games</color></b>",
            "<b><color=#FF6688>* Live 2v2 Now</color></b>  <color=#888>({0})</color>",
            "<b><color=#FF6688>* Live 2v2 Series</color></b>",
            "<b><color=#FFB347>Solo Leaderboard</color></b>  <color=#888>(unranked)</color>",
            ...
            "<b><color=#FFD94D>PRIZES</color></b> <color=#888>(at {0} players)</color>",
            "<b><color=#FFD94D>PRIZES</color></b> <color=#888>(at {0} players, live)</color>",
            "<b><color={0}>{1}</color></b>  <color=#888>(unranked - loading...)</color>",
            "<b><color={0}>{1}</color></b>  <color=#888>(unranked - no games yet)</color>",
            "<b><color={0}>{1}</color></b>  <color=#888>(unranked - {2} players)</color>",
            "<b>Admin Panel</b>  <color=#888>(admins only)</color>",
            "<b>Bet on Live FFA Lobbies</b>",
            "<b>Chat Moderation</b>  <color=#888>(your granted channels only)</color>",
            "<b>Custom 1v2 Lobbies</b>",
            "<b>FFA - FREE-FOR-ALL (3-10 players)</b>",
            "<b>FFA Leaderboard</b>",
            "<b>FFA Leaderboard</b>  <color=#888>({0} ranked)</color>",
            "<b>FFA Leaderboard</b>  <color=#888>- no ranked FFAs yet</color>",
            "<b>Game logs (tail)</b> — included with your report when the box is checked.",
            "<b>Hosted 2v2 Lobbies</b>",
            "<b>How to reproduce?</b> <color=#888>(optional)</color>",
            "<b>Open FFA Lobbies</b>",
            "<b>Open FFA Lobbies</b>  <color=#888>(none right now)</color>",
            "<b>Open FFA Lobbies</b>  <color=#888>({0})</color>",
            "<b>Recent 1v2 Games</b>",
            "<b>Recent 1v2 Games</b>  <color=#888>({0} series)</color>",
            "<b>Recent 1v2 Games</b>  <color=#888>- none yet</color>",
            "<b>Recent 2v2 Series</b>",
            "<b>Recent 2v2 Series</b>  <color=#888>({0} total)</color>",
            "<b>Recent 2v2 Series</b>  <color=#888>— none yet</color>",
            "<b>Recent Casual FFAs</b>",
            "<b>Recent Casual FFAs</b>  <color=#888>({0} total)</color>",
            "<b>Recent Casual FFAs</b>  <color=#888>- none yet</color>",
            "<b>Recent Ranked FFAs</b>",
            "<b>Recent Ranked FFAs</b>  <color=#888>({0} total)</color>",
            "<b>Recent Ranked FFAs</b>  <color=#888>- none yet</color>",
            "<b>Start (need {0})</b>",
            "<b>Start Game ({0}/{1})</b>",
            "<b>What happened?</b> <color=#FF9966>(required)</color>",
            "<b>You</b>",
            "<b>Your 2v2 Lobby</b>",
            "<b>Your Custom 1v2 Lobby</b>",
            "<b>Your Lobby</b>  <color=#888>({0}/{1} - host starts at {2}+)</color>",
            "<b>vs You:</b> <color={0}>{1}W - {2}L ({3} games)</color>",
            "<b>{0} Performance patches</b>  {1}",
            "<b>{0}</b>  <color=#888>(empty)</color>",
            "<color=#00FF00><b>WON</b></color> {0}-{1}",
            "<color=#00FF00>Linked to Discord</color> ({0})",
            "<color=#00FF00>Linked to Discord</color> <color=#888>(Click to show)</color>",
            "<color=#00FF00>WON</color>",
            "<color=#00FFFF>{0}</color>  - type <color=#FFFFFF>!link {1}</color> in Discord",
            "<color=#44AA44>Up to date</color>",
            "<color=#44FF44>Close ROUNDS to apply update</color>",
            "<color=#556270>(hover for build)</color>",
            "<color=#556270>(hover for builds)</color>",
            "<color=#664444>-> {0} bet {1}g on {2} - lost</color>",
            "<color=#666>(click to copy)</color>",
            "<color=#666><i>Hide yourself here: Settings -> Appear offline.</i></color>",
            "<color=#666><i>No live ranked series right now.</i></color>",
            "<color=#666><i>no cards</i></color>  <color=#556270>(hover for build)</color>",
            "<color=#666>no cards</color>",
            "<color=#666>no cards</color>  <color=#556270>(hover for build)</color>",
            "<color=#666>—</color>  <b>Game {0}</b>: {1} {2}-{3}",
            "<color=#667788>none held</color>",
            "<color=#667788>none</color>  <color=#556270>(hover for build)</color>",
            "<color=#667788>series:</color>",
            "<color=#6677AA>You:</color>",
            "<color=#667>click an achievement to see who earned it</color>",
            "<color=#66CCFF>Downloading...</color>",
            "<color=#66CCFF>Searching for {0}...</color>  <b>{1}/4</b>",
            "<color=#66DD66>APPROVED</color>",
            "<color=#66DD66>APPROVED</color> <color=#888>(rev {0} awaits a mod update)</color>",
            "<color=#66DD66>Game starting! Joining as player {0} of {1}...</color>",
            "<color=#66DD66>In FFA match.</color>",
            "<color=#66DD66>In a 1v2 match.</color>",
            "<color=#66DD66>Match found! Joining…</color>  <color=#FFB347>{0}</color> <color=#888>vs</color> <color=#88AAFF>{1}</color>",
            "<color=#66DD66>Your lobby is ready.</color> {0} in - press Start, or wait for more (up to {1}).",
            "<color=#66FF88>Online now</color>",
            "<color=#777>(bet placed)</color>",
            "<color=#777>(hover for score graph)</color>",
            "<color=#777>(your lobby)</color>",
            "<color=#777><i>hover the panel and scroll for more</i></color>",
            "<color=#777>rounds on the left - each step is one point scored</color>",
            "<color=#777>{0} activated / {1} successful</color>",
            "<color=#777>{0} activated · {1} successful · {2:F0}%</color>",
            "<color=#777>{0} dmg / {1} blocks</color>",
            "<color=#777>{0} dmg taken · {1} successful blocks</color>",
            "<color=#777>{0} fired / {1} hit ({2:F0}%)</color>",
            "<color=#777>{0} fired · {1} hit · {2:F0}%</color>",
            "<color=#7788AA>-> {0} bet {1}g on {2} - pending</color>",
            "<color=#7788AA><i>search cards...</i></color>",
            "<color=#7788AA><i>search players...</i></color>",
            "<color=#7788AA><i>search...</i></color>",
            "<color=#7788AA><i>subject</i></color>",
            "<color=#7788AA><i>write your message... (plain text, no formatting)</i></color>",
            "<color=#7FD4FF>1v2 History</color>",
            "<color=#7FD4FF>1v2:</color> {0}W/{1}L",
            "<color=#7FE8C3>=  CHARACTER COSMETICS  =</color>",
            "<color=#7FE8C3>Every signup past 8 grows the pot - 16 players doubles it! (now: {0})</color>",
            ...
            "<color=#888>(click the row to preview tracks)</color>",
            "<color=#888>(equip in the character editor)</color>",
            "<color=#888>(in progress)</color>",
            "<color=#888>(last approved placement stays active)</color>",
            "<color=#888>(no cards recorded)</color>",
            "<color=#888>(none right now)</color>",
            "<color=#888>(solo extra pick)</color>",
            "<color=#888>+pick</color>",
            "<color=#888>+{0} more live games - see the mode tabs</color>",
            "<color=#888>+{0} more</color>",
            ...
            "<color=#888><i>Hidden</i></color>",
            "<color=#888><i>Loading match history...</i></color>",
            "<color=#888><i>Loading release notes...</i></color>",
            "<color=#888><i>No messages yet. Messages sent here or in #scr-discussion on Discord show up here.</i></color>",
            "<color=#888><i>No sales yet.</i></color>",
            "<color=#888><i>No stat data available for this card.</i></color>",
            "<color=#888><i>Nobody has earned this yet. Be the first!</i></color>",
            "<color=#888><i>Nobody visible right now.</i></color>",
            "<color=#888><i>None yet.</i></color>",
            "<color=#888><i>Release notes unavailable right now.</i></color>",
            "<color=#888><i>Update of {0} - grab them in the Shop tab.</i></color>",
            "<color=#888><i>Updates of {0} & {1} - grab them in the Shop tab.</i></color>",
            "<color=#888><i>v  Scroll down for leaderboard + recent series  v</i></color>",
            "<color=#888>Agree a time in Discord (or /dm-opponent), then play a private lobby - it counts automatically.</color>",
            "<color=#888>Discord:</color>",
            "<color=#888>Leaving queue…</color>",
            "<color=#888>Leaving...</color>",
            "<color=#888>Loading earners...</color>",
            "<color=#888>Loading members...</color>",
            "<color=#888>Loading…</color>",
            "<color=#888>Mod: <i>not detected</i></color>",
            "<color=#888>Mod:</color>",
            "<color=#888>No custom 1v2 lobbies — create one and invite your friends!</color>",
            "<color=#888>No hosted 2v2 lobbies — create one and invite your friends!</color>",
            "<color=#888>No items assigned to you yet - art gets wired to your account when it ships in a mod update.</color>",
            "<color=#888>No one in {0} right now.</color>",
            "<color=#888>No open lobbies — create one and invite players on Discord!</color>",
            "<color=#888>Pick <b>Search Random</b> for ranked matchmaking, or host a 2v2 lobby below to choose teams.</color>",
            "<color=#888>Ranked by default - the host can switch a lobby to Casual before starting.</color>",
            "<color=#888>Select 2+ players with ranked history to compare Elo.</color>",
            "<color=#888>Select 2+ players with rated FFA history to compare FFA Elo.</color>",
            "<color=#888>Solo Extra Initial Pick: the solo gets one extra card in the game's FIRST draw only. The HOST's toggle decides it for the match.  <color=#7FDF7F>Active in-game</color> <color=#888>— the solo's first pick screen deals twice.</color>",
            "<color=#888>Steam ID:</color>",
            "<color=#888>click anywhere to close</color>",
            "<color=#888>sold {0}, gifted {1}</color>",
            "<color=#888>{0}% pen</color>",
            "<color=#888>{0}</color>  <b>{1}</b> bought <color=#C8A2FF>{2}</color> for <color=#FFD94D>{3}g</color>  <color=#7FE8C3>+{4}g to you</color>",
            "<color=#888>{0}</color>  <b>{1}</b> received <color=#C8A2FF>{2}</color>  <color=#888>(gift)</color>",
            "<color=#8899AA>1 - 2,000 gold</color>",
            "<color=#8899AA>How long are you searching? (shown to players as an expiry)</color>",
            "<color=#8899AA>Pings the Ranked Looking For Player role (max 1 per hour). Optional message:</color>",
            "<color=#8899AA>Search</color>",
            "<color=#8899AA>Which modes? (pick any)</color>",
            "<color=#88AAFF>Type to filter</color>",
            "<color=#88AAFF>duo won</color>",
            "<color=#88CC88>-> {0} bet {1}g on {2} -> <b>+{3}g</b></color>",
            "<color=#88FF88>Equipped.</color>",
            "<color=#88FF88>In a custom 1v2 lobby</color> <color=#888>— manage it in the panel below.</color>",
            "<color=#88FF88>In a hosted 2v2 lobby</color> <color=#888>— manage it in the panel below.</color>",
            "<color=#88FF88>Profile anonymized. Data reporting is now off; past matches stay.</color>",
            "<color=#88FF88>Purchased!</color>",
            "<color=#88FF88>Ready! Waiting for the other 3...</color>",
            "<color=#88FF88>Sent! Thank you. Filed as <b>#{0}</b>.</color>",
            "<color=#88FF88>Sent! Thank you.</color>",
            "<color=#88FF88>{0}/{1} active</color>",
            "<color=#8A8A93>Research and write-up by Spirit - 'On Damage Types and Buff Activation', University of Rounds. Reproduced for this library with light reformatting; the testing, the findings and the voice are all his.</color>\n\nVia thorough testing in the sandbox game mode with an additional controller player, I have catalogued which types of damage trigger which cards and buffs. The main cards in question are Scavenger, Refresh, Brawler, and Taste of Blood. Lifesteal as a character stat bestowed by numerous cards has also been considered. My results split damage into three main categories: opponent damage, self-damage, and Conditional damage. Damage to your opponent via nearly any means will trigger all cards and buffs, with the exception of specific types of Conditional damage. For various reasons, some Conditional damage, typically from block cards, will not consistently trigger Refresh but will still trigger all other buffs. Finally, any form of self-damage will always activate Scavenger, but nothing else. There are, of course, numerous oddities and exceptions.",
            "<color=#8FA3B8>finished in {0}</color>",
            "<color=#8FA3B8>{0} fps</color>",
            ...
            "<color=#99B3E6>You: Hit {0}%</color>",
            "<color=#99CCFF>Block:</color> -",
            "<color=#99CCFF>Block:</color> {0:F1}% ({1}/{2})",
            "<color=#99CCFF>Block:</color> {0}% <color=#888>({1}/{2})</color>",
            "<color=#9AD0FF>=  CURSOR COLORS  =</color>",
            "<color=#9AD0FF>Your submissions:</color>",
            "<color=#A0D4FF>=  TRAILS  =</color>",
            "<color=#AA9955>-> {0} bet {1}g on {2} - refunded</color>",
            ...
            "A grin for those who feel most devious",
            "A hard helmet for those who are going to war and need to cover their heads",
            "A hot pink mouse cursor.",
            "A light, warm skin tone.",
            "A muted, earthy olive green.",
            "A pack is still being resolved - hold on",
            "A pack is still being resolved - it will be checked again shortly",
            "A player hasn't received the new settings yet - try again in a moment.",
            "A player in this game has spectating disabled.",
            "A player's mod is too old for these settings - they need to update, or turn the setting off.",
            "A quick follow-up shot (QShoot) counts as Conditional damage",
            ...
            "A royal purple mouse cursor.",
            "A shimmering rainbow of particles cycles around you.",
            "A shot placed second: the shot Refreshes and resets the flag",
            "A shot placed third: an extra Refresh",
            "A silly little mouth for feline ethusiasts",
            "A silver trail with white twinkles. Leave a little sky behind.",
            "A sleek black mouse cursor.",
            "A slow starfield in violet and blue. Bring your own gravity.",
            "A small grey cat based on my real cat",
            "A soft amber distinct from Gold.",
            "A soft green aura that says you know what you're doing.",
            "A stylish hat for those in the mafia",
            "A sun-kissed medium skin tone.",
            "A sunny yellow mouse cursor.",
            "A vibrant green between Gold and Cyan.",
            "A vivid green mouse cursor.",
            "A warm coral pink matching the new Coral body.",
            "A warm coral pink with hints of orange.",
            "A winners-bracket loss drops to the lower lane; lose there and you are out.",
            "A zesty yellow-green.",
            "AFK: zero shots, blocks, picks",
            "ALL CAPS",
            "ALT",
            "ALT (tap, while typing in chat) - switch the chat language channel",
            "ARTIST STUDIO",
            "ASYNC (6-week)",
            ...
            "Active",
            "Add a subject.",
            "Add an underline to your name. Stackable with other name styles.",
            "Add at least one recipient.",
            "Add extra character spacing.",
            "Add recipient",
            "Adjust Placement...",
            "Admin",
            "Admin action",
            "Admin action log ({0}-{1} of {2})",
            "Admins - type to search",
            ...
            "All picks (oldest first) - red = replaced:",
            "All spectator seats are taken.",
            "All-time: {0} games ({1}W-{2}L), series {3}-{4}",
            "Allow data reporting",
            "Allow other players to spectate your ranked games. Turning this off also removes current spectators.",
            "Allow spectators: <color=#888>...</color>",
            "Allow spectators: <color=#88FF88>ON</color>",
            "Allow spectators: <color=#FF9966>OFF</color>",
            ...
            "Amethyst",
            "Ammo",
            "An aurora follows you. Green and violet shimmer with sparkles.",
            "Animated cosmetics: <color=#88FF88>ON</color>",
            "Animated cosmetics: <color=#FF9966>OFF</color>",
            "Animated cosmetics: prismatic/chrome body colors, prism trail, player effects, map-skin shimmer, animated faces. Off = everything freezes on a static frame.",
            "Announce my pulls: <color=#888>...</color>",
            "Announce my pulls: <color=#88FF88>ON</color>",
            "Announce my pulls: <color=#FF9966>OFF</color>",
            "Announcement",
            "Anonymizes your Steam ID, display name, and Discord link. Matches stay so other players' Elo and histories aren't affected. You will no longer appear on leaderboards.\n<b><color=#FF8888>IRREVERSIBLE:</color></b> this Steam ID can never re-register. Future matches from this account will show as [Deleted User] and won't count toward stats.",
            "Another Round",
            "Anti-cheat",
            "Apex",
            ...
            "Aurora Gradient",
            "Average FPS",
            "Average game length: {0}",
            "Avg Cards / Game",
            "Avg Cards per Game  (lower = stronger)",
            "Avg FPS",
            "Avg Game Length",
            "Avg Game Length (minutes)",
            "Avg Key Presses per Game",
            "Avg Keystrokes per Second (in combat)",
            "Avg Mate Elo",
            "AvgPl",
            "Avoid in Ranked Matchmaking",
            "Azure Comet",
            "B (in a lobby) - add a practice bot",
            "BOARD",
            "BOARD\u0004pc.stat.board",
            "Babel",
            "Back",
            "Back in the Quick Match queue — searching for an opponent.",
            "Balance: -",
            "Balance: <color=#FFD94D>{0}</color> gold",
            "Ballooniphones",
            "Ban",
            "Ban Steam ID...",
            "Ban a player",
            ...
            "Banned",
            "Banned Players",
            "Banned players - type to search",
            "Be right back",
            "Beat Sid in a ranked series",
            "Beat Stan in a ranked series",
            "Begin the window",
            "Beginner",
            "BepInEx (current)",
            "BepInEx (prev session)",
            "Berserker",
            "Best Win Streak",
            "Best seller",
            "Best-of-3: first side to 2 game wins. 1v2 is an unranked beta - every game is recorded, and no rating moves yet.",
            "Bet",
            "Bet cancelled - your gold is back.",
            "Bet failed: {0}",
            "Bet on which pair? Pick 2",
            "Bet on which player?",
            "Bet placed: {0}g",
            "Bet placed: {0}g on Team {1}",
            "Bet placed: {0}g on {1}. {2}",
            "Bet placed: {0}g{1}{2}",
            "Beta",
            "Bets Won / Lost",
            "Betting",
            ...
            "Block CD",
            "Block a Player...",
            "Block debug overlay (corner): blocks you started vs blocks that actually absorbed a hit, plus why each one missed (too early / too slow / unblockable).",
            "Block debug overlay: <color=#88FF88>ON</color>",
            "Block debug overlay: <color=#FF9966>OFF</color>",
            "Block rate - {0}",
            "Block sender",
            "Block {0}%",
            "Block {0}? Their mail will no longer reach you. You can unblock them in Settings.",
            "Blocked senders ({0})",
            "Blocked senders: loading...",
            "Blocked senders: show",
            "Blocked {0}.",
            "Blocking",
            "Blocks",
            "Blood Gradient",
            ...
            "Boosters",
            "Both clients watch everything; only the elected reporter sends. Duplicates are absorbed, and the server re-checks ranked or casual when the report lands.",
            "Both ready! Joining match...",
            "Bouncer",
            "Bounces",
            "Bouncy",
            "Bouncy main",
            ...
            "Bracket Reset",
            "Brain Cane",
            "Bright electric-cyan body color.",
            "Bright embers cooling into ash. Two-color gradient.",
            "Bright industrial blue body color.",
            "Broadcast [{0}] \"{1}\" to ALL players? It stands until revoked.",
            "Bronze",
            "Browse open lobbies below, or create your own.",
            "Bubbles",
            "Bug Reports...",
            "Bug fixes the mod ships",
            "Bug report sent. Thanks!",
            "Bug report sent. Thanks! (#{0})",
            "Build Types",
            "Build at game end",
            "Builds",
            "Builds that stacked 2+ copies (all players)",
            "Built for ranked.",
            "Bullet Hell",
            "Bullet damage",
            "Bullet slow",
            "Bullet spd",
            "Bullet-hit particle cap (2/frame)",
            "Bullets",
            "Burgundy",
            "Bursts",
            "Buy",
            ...
            "CASUAL, RECORDED",
            "COM",
            "COM\u0004pc.band_short.common",
            "COMMON",
            "COMMON\u0004pc.band.common",
            "COMPLETED",
            "COMPLETED SERIES",
            "CONFIRM LEAVE",
            "CRASH",
            "Calendar",
            "Calm forest-green tint with low saturation.",
            "Camera screen shake on shots/hits/deaths. Full = vanilla. Reduced = softer, keeps the hit feedback. Off = a perfectly steady camera. Local only.",
            "Can't open the portal - this install is on an insecure backup connection. Restart ROUNDS to retry the secure one.",
            "Cancel",
            "Cannot spectate: {0}",
            "Cap bullet-hit particles at 2/frame — biggest user-visible win on heavy firefights.",
            ...
            "Card Win Rate",
            "Card draw:",
            "Card picks close in {0}s",
            "Card pictures & settings",
            "Card pool: no snapshot yet",
            "Card pool: {0} players (snapshot {1}) - {2} cards in your binder",
            "Cards",
            "Cards:",
            "Cards: <color=#88FF88>FULL</color>",
            ...
            "Casual Conqueror",
            "Casual History",
            "Casual Opponents Who Quit on You % (higher is better)",
            "Casual games",
            "Casual games keep their stats and XP but never move rating.",
            "Casual: -",
            "Casual: {0}W / {1}L",
            "Casual: {0}W / {1}L ({2})",
            "Casual: {0}W/{1}L",
            ...
            "Chat  <color=#888>(press T to chat)</color>",
            "Chat Lockdown...",
            "Chat Mutes...",
            "Chat [{0}]  —  Enter to send, Esc to cancel, Alt switches channel",
            "Chat fade after: <color=#88CCFF>{0}</color>",
            "Chat fade after: <color=#FF9966>Off (chat hidden in game)</color>",
            "Chat has been locked by moderators - messages are paused.",
            "Chat has been unlocked - carry on.",
            "Chat has language channels - use the dropdown on the Home tab, or tap Alt while typing, to switch.",
            "Chat is currently LOCKED.",
            "Chat is currently open.",
            "Chat is locked by moderators right now - your message was not sent.",
            "Chat mutes - type to search",
            "Chat notifications: <color=#88FF88>ON</color>",
            "Chat notifications: <color=#FF9966>OFF</color>",
            "Chat overlay: MUTED - hidden, and the room is told",
            "Chat overlay: NORMAL - messages fade out",
            "Chat overlay: PINNED - messages stay on screen",
            "Choose a metric",
            "Choose cards (left) to compare {0}.",
            ...
            "Claimed - the next one unlocks in {0}",
            "Claimed for today",
            "Claiming...",
            "Clamp ObjectPool init-spawn to 4 in-match — reduces frame stutter from new pool allocation.",
            "Clean House",
            "Clean Trail",
            "Clean white body color.",
            "Clear",
            "Clear Search",
            "Click <b>Search Random</b> to start finding a 2v2.",
            "Click Discard again to discard that card for shards",
            "Click Dupes again to discard every other copy of that card",
            "Click MAIN MENU again to leave the match.",
            "Click a player",
            ...
            "Clutch",
            "Cobalt",
            "Cold violet and cyan motes swirl in a dark halo.",
            "Collection",
            "Collector",
            "Colorize your name in cyan.",
            "Colorize your name in gold.",
            "Colorize your name in green.",
            "Colorize your name in pink.",
            "Colorize your name in purple.",
            "Colorize your name in red.",
            "Colossus",
            "Common",
            "Common\u0004card rarity",
            "Community artist sales - who has items up for sale, and what they've earned",
            "Community artists supply a large share of the catalog and earn a 30% royalty on every sale - gifts pay no royalty.",
            "Compare",
            "Compare Cards",
            "Compare Players",
            "Competitive ROUNDS — Data Consent",
            "Competitor",
            "Conditional",
            "Conditional - every other time; see RefreshValid below",
            "Confirm",
            "Confirm — really delete",
            "Connecting to the game...",
            "Connection was lost — returning to menu.",
            "Constantly cycles through the rainbow during a match.",
            "Controlled Burst",
            "Controls & keys",
            "Cool blue energy crackling behind you.",
            "Cool desaturated slate-grey — easy on the eyes.",
            "Cool grey body color.",
            "Cool grey-blue blocks on a dim cool backdrop.",
            "Cool teal body color.",
            "Cool teal wake, fresh from the shallows.",
            ...
            "Custom player body colors: shows shop-bought Body Colors on you and other modded players. Off = everyone falls back to default orange/blue.",
            "Cyan Cursor",
            "Cyan Name",
            "DISCARDED",
            "DISCARDED\u0004pack open",
            "DISCARDED (+{0} shards)",
            "DOT TICKS VS THE BLOCK WINDOW",
            "DPS",
            "DUPLICATE +{0}",
            "DUPLICATE +{0}\u0004pack open",
            "Daily limit reached - paid packs reset at midnight UTC",
            "Damage",
            "Damage dealt (cumulative per game)",
            "Damage types & buffs",
            "Dance is on cooldown - try again in a moment.",
            "Dances",
            "Dark Aura",
            ...
            "Dark red blocks on a dim warm backdrop.",
            "Dark steel walls with amber window glow against a black-navy sky, city lights twinkling behind.",
            "Data & Privacy",
            "Data sharing is disabled in your settings",
            "Data sharing is off - allow it in Settings to use mail.",
            "Date Earned",
            "Date format",
            "Date format: <color=#88CCFF>{0}</color>",
            "Day/Month/Year",
            "Deadlines & forfeits",
            "Deal Conditional damage",
            "Deal damage",
            "Deaths",
            "Decent",
            "Decline",
            ...
            "Deep cool dusk blues with dimmed exposure.",
            "Deep evergreen blocks on a dimmed green-tinged backdrop.",
            "Deep forest green rising to bright jade. Two-color gradient.",
            "Deep green hedges and bark-brown walls on a dark brown night.",
            "Deep ocean midnight — black with a hint of cold blue.",
            "Deep ocean-blue body color.",
            "Deep red smoke following your every move.",
            "Deep royal purple, the kind that absorbs every photon.",
            "Default",
            "Default (random)",
            "Default start: <color=#AABBEE>{0}</color>   Signups close: {1}",
            "Delete",
            "Delete Chat Message...",
            "Delete My Data",
            "Delete My Data...",
            "Delete a chat message - type to search",
            "Delete chat message",
            "Delete this message?",
            "Demolitionist",
            "Demon Wings",
            "Despawn off-screen bullets — host clears bullets that exit the camera viewport.",
            "Detail: a shooting star circling overhead (animated). Equip in the Character editor.",
            "Detail: certified angel. Equip in the Character editor.",
            "Detail: community cosmetic. Ships with the next mod update; equip in the Character editor.",
            "Detail: cozy star-studded earmuffs. Equip in the Character editor.",
            "Detail: heavy is the head. Equip in the Character editor.",
            "Details",
            "Details (optional)",
            "Devil Horns",
            "Diagram of Spirit's research, 'On Damage Types and Buff Activation'.",
            "Different players who have picked this card",
            "Disable",
            "Discard",
            "Discard this draft?",
            "Discarded {0} card(s) for {1} shards",
            "Discarded {0} card(s) for {1} shards; then: {2}",
            "Discarding a card gives shards by its rarity: Common 5, Uncommon 15, Rare 40, Epic 150, Legendary 600. Shards buy packs. Discards are one card at a time; the Dupes button discards every other copy of that exact card.",
            "Disco Fever",
            "Discord",
            "Discord Link",
            "Dismiss (1 min)",
            ...
            "Do nothing",
            "Done.",
            "Double KO - nobody scored this round.",
            "Double Nova",
            "Downloading full album...",
            "Downloading music previews...",
            "Downloading music...",
            "Downloading update...",
            "Downloading...",
            "Dragoman",
            ...
            "Dupes ({0})",
            "Dusk",
            "Dusky pink burning into crimson. Two-color gradient.",
            "Dusty rose blocks on a warm dim backdrop.",
            "Dusty rose fading into indigo night. Two-color gradient.",
            "E (hold) - dance wheel; dancing locks your controls",
            "EDGE BOUNCE AND WALL-JUMP WINDOWS",
            "ENTER - room code box / vanilla chat",
            "EPIC",
            "EPIC\u0004pc.band.epic",
            "EPIC\u0004pc.band_short.epic",
            "EQUIP",
            "ESC - closes this menu first, then the game menu",
            "EVERY DAMAGE OUTCOME",
            "EVERYTHING TRAVELS THROUGH PHOTON",
            "Each letter of your name in a different color of the rainbow.",
            "Each level costs more XP than the last (level^1.5). Every gold dot is a level-up: 100g each through 50, 500g after.",
            "Each pack holds {0} cards. A card's rarity is its player's rank in the card pool on the day of the pull: Legendary = #1, Epic #2-10, Rare #11-20, Uncommon #21-40, Common #41 and below. Odds per card: Common 60%, Uncommon 25%, Rare 11%, Epic 3.5%, Legendary 0.5%. Every card also rolls Foil (1 in 200) and Signed (1 in 2000) on its own.",
            "Each player's worst ranked 1v1 opponents - minimum 3 series, top 5",
            "Each seat simulates its own replicas. Damage is computed on the shooter's seat and relayed as a final number.",
            "Each unlocks once per account and pays on the spot: most pay 100g; the hardest pay 300g, 500g or 1000g.",
            "Earned",
            "Earned by {0} player  <color=#888>(in the order they got it - click again to close)</color>",
            "Earned by {0} players  <color=#888>(in the order they got it - click again to close)</color>",
            "Earned pack (ranked win)",
            "Earned pack (sweep)",
            "Ears for those who feel very lucky",
            "Earth Gradient",
            "Eats damage",
            "Echo",
            "Echo main",
            "Eclipse",
            "EdgeBounce NRE swallow",
            "Edition",
            "Edition\u0004pc.edition",
            "Effects",
            "Electric sparks snap and dart around you.",
            "Electric-cyan neon name with a soft glow halo. Visible to everyone; modded players also see the glow.",
            "Elo",
            "Ember",
            "Ember Gradient",
            "Embers",
            ...
            "FFA match found, but you're in a game — removed from the FFA queue.",
            "FFA session - {0} players",
            "FFA session - {0} players, {1} games",
            "FFA: placed #{0} (+{1}xp)",
            "FFA: your tally is kept and scored from your exit under the early-leave rules.",
            "FIRST TO {0}   -   {1} OPENING DRAW   -   {2}-CARD HAND",
            "FIRST TO {0}   -   {1} OPENING DRAWS   -   {2}-CARD HAND",
            "FLAG",
            "FOIL",
            "FOIL\u0004pc.foil",
            "FOIL\u0004pc.foil_short",
            ...
            "Fast Forward main",
            "Fast finisher",
            "Favorite ranked cards",
            "Few reach it. Fewer afford the title.",
            "Field Medic",
            "Finish a game with the exact same 5 cards (and copies) as your opponent",
            "Finish or leave your current game before joining the 1v2 queue.",
            "Finish or leave your current game before joining the FFA queue.",
            "Finish or leave your current game first.",
            "Finishing your previous leave first...",
            "Fireflies",
            ...
            "Flawless",
            "Floating Name",
            "Floating pink hearts rise from your body.",
            "Follow my character",
            "For sale",
            "For the silly ones. Takes up the mouth slot",
            "For those who earned the right. Still costs a fortune.",
            "Force Start",
            "Force exit room",
            "Force your name to render uppercase.",
            "Force-start unlocks at {0} signups ({1}/{2})",
            "Force-start votes: {0}/{1}",
            "Forest",
            "Forest Fire",
            "Forfeit",
            "Forfeit failed",
            ...
            "GAME ENDS",
            "GAMEPLAY",
            "GET READY - fire and block unlock in a moment",
            "GRAND FINAL",
            "Galaxy",
            "Galaxy Gradient",
            "Game",
            ...
            "Game Mechanics",
            "Game over - {0} wins",
            "Game records (all players) - hover a row for the cards",
            "Game {0}",
            "Game {0}   {1} players",
            "Game {0}   {1} {2} {3}",
            "Game {0} - {1} players",
            "Game {0} score progression",
            "Game {0}: solo {1}-{2} duo",
            "Game {0}: team 1 {1}-{2} team 2",
            "Game {0}: {1}",
            "Game {0}: {1}-{2}",
            "Games",
            "Gentle soap bubbles float up around you.",
            ...
            "Grant Artist...",
            "Grant Translator...",
            "Grant a translation role - find the player",
            "Grant data consent first (Settings)",
            "Graphs {0}/{1}",
            "Green Cursor",
            "Green Name",
            "Grey Cat",
            ...
            "HIGH",
            "HOST",
            "HOW A COSMETIC REACHES YOUR BODY",
            ...
            "Heartbreak",
            "Hearts",
            "Held by the top 3 on the 1v1 ranked leaderboard",
            "Held by the top 3 on the 2v2 leaderboard",
            "Held by the top 3 on the FFA leaderboard",
            "Hello!",
            "Help translate the mod - opens the web portal in your browser. An admin has to give you translator access before you can submit.",
            "Hide Gold",
            "Hide your gold balance from everyone on the leaderboard. Toggle it on or off any time from the Other tab.",
            "Hides you from the Home tab's online and recently-online lists.",
            "Higher placement takes a bigger share of the pot; the pot itself scales with lobby size, battles played and opponent tier.",
            "Highest Avg DPS",
            "Highest Health",
            "Highest Single Hit",
            "Hips one way, arms the other - the classic. Dancing locks your controls for the duration.",
            "Hit",
            "Hit %",
            "Hit % vs Block %",
            "Hit / Block %",
            ...
            "Hit {0}%",
            "Hit {0}% Blk {1}%",
            "Hit-sound NRE swallow",
            "Hold on!",
            "Home",
            "Homing main",
            "Honk honk.",
            "Hop to attention - arms snap up and out on every beat. Dancing locks your controls for the duration.",
            "Hop to the beat, arms pumping. Play it between rounds with the E wheel.",
            "Hostile Takeover",
            "Hot-pink neon name with a soft glow halo. Visible to everyone; modded players also see the glow.",
            "How It Works",
            "How It Works - Async (6-week)",
            "How It Works - Sync (weekly)",
            "How dates are written across the mod's menus (history rows, leaderboards, tournaments).",
            "How games are tracked",
            "How long a chat message stays fully visible before it fades. Ignored while the overlay is pinned.",
            "How long for {0}?",
            "How long?",
            "How much damage?",
            ...
            "How to get packs",
            "How tournaments run",
            "However, this is if you only use Silence. Other Refresh activators can disrupt the every-other pattern: hit your opponent with a bullet (non-Conditional damage) and you receive a successful Refresh AND reset RefreshValid to false. Depending on where in the pattern you put your shot, you can snag an extra Refresh (the second and third sequences above).\n\nSadly, this is not the end of the document, because the ROUNDS developers saw fit to introduce another mechanic. I do hope you, dear reader, appreciate the relative ease with which you get to possess this information as compared to the hours of madness I spent obtaining it.",
            "Huge",
            "Huge Name",
            "Huge main",
            "Hypno-spiral eyes. Completely unhinged.",
            "I can be a Player Card: <color=#888>...</color>",
            "I can be a Player Card: <color=#88FF88>ON</color>",
            "I can be a Player Card: <color=#FF9966>OFF</color>",
            "I play with a competitive framework mod called Sid's Competitive Rounds",
            "I'm ready",
            "Icy blue trail fading to white. Two-color gradient.",
            "Idiot",
            "If no earlier rule settles it, score, check-in, no-show rate and a fixed tiebreak decide.",
            "Immortal",
            "Immovable Object",
            "In a game — no results yet",
            "In-combat particle aura around your character. Only visible to modded players.",
            "In-game chat overlay: <color=#88CCFF>PINNED</color>",
            ...
            "Info",
            "Input overlay (bottom-left): shows W, A, S, D, Space and both mouse buttons. Lights up red when pressed. Useful for streams or spotting missed inputs.",
            "Input overlay: <color=#88FF88>ON</color>",
            "Input overlay: <color=#FF9966>OFF</color>",
            "Inside the 0.35 s window?",
            "Instinct",
            "Interface",
            "Intermediate",
            "Into the Deep End",
            "Iron",
            "Iron Bracket",
            "Is RefreshValid true?",
            "Italic",
            "Ivory",
            "Join",
            "Join Competitive Rounds!",
            "Joined the match!",
            "Jump",
            "Jumping Jacks",
            "Jumps",
            "Just under half of a payout arrives as XP, the rest as gold. Rating moves from pairwise comparisons against the finishers nearest you.",
            ...
            "LEAVE MATCH",
            "LEG",
            "LEG\u0004pc.band_short.legendary",
            "LEGENDARY",
            "LEGENDARY\u0004pc.band.legendary",
            "LEVEL UP!  Level {0}",
            "LIVE",
            "LMB",
            "LMB - shoot.  RMB - block",
            ...
            "LOCK: 2 total points",
            "LOCKED",
            "LOCKED\u0004betting window",
            "LOCKED - STARTING SOON",
            "LOSERS BRACKET: one winners-bracket loss drops you here; a loss here eliminates you",
            "LOW",
            "LOWER STEAM ID",
            "Lag notices: <color=#88FF88>ON</color>",
            "Lag notices: <color=#FF9966>OFF</color>",
            "Lagoon",
            "Language / Idioma / Язык / Мова / Språk",
            "Language: <color=#88CCFF>{0}</color>",
            "Last game for me",
            "Last met: {0}  -  {1}  -  {2}",
            "Last played {0} · H2H {1}-{2} · Ranked series {3}",
            "Last played {0} · also played today · H2H {1}-{2} · Ranked series {3}",
            "Last seen {0}",
            "Latest Releases",
            "Lavender",
            "Leaderboard",
            ...
            "Leave Signup",
            "Leave it open",
            "Leave this competitive match? Click again to confirm. Standard disconnect and early-leave rules apply - this is not a guaranteed forfeit.",
            "Leave your 2v2 lobby first.",
            "Leave your current game first.",
            "Leave your custom 1v2 lobby first.",
            "Leaving queue...",
            "Left 1v1 queue - you joined a game",
            "Left all queues",
            "Left the 1v1 match queue - you joined a game",
            "Left tournament signup",
            "Left your FFA lobby - you joined a competitive game",
            "Left your game to join the queued match - no leave will be recorded.",
            "Legendary",
            "Lemon",
            "Less than 5",
            "Lets others see which cards you hold, in the mod and in Discord.",
            "Level 1",
            "Level {0}",
            "Level-ups",
            "Life steal",
            ...
            "Manual restoration marked complete.",
            ...
            "Match canceled — searching again...",
            "Match could not start — only {0} of {1} players connected. Leave to the menu to requeue.",
            "Match dissolved — searching again...",
            "Match recorded",
            "Matchmaking hiccup — putting you back in the Quick Match queue...",
            "Matchmaking keeps failing - returning to menu. Please try again in a minute.",
            "Max cards:",
            "Max {0} cards",
            "Max {0} players",
            ...
            "Menu update bail",
            "Message (shown to every player)",
            "Midas",
            "Midnight",
            "Militia Man",
            "Mint",
            "Mirrored chrome with a soft shifting tint.",
            "Mod display language. Machine-translated drafts until community moderators review them — card text in matches follows ROUNDS' own language setting.",
            "Mode: <color=#88CCFF>vanilla music</color>",
            "Mode: <color=#88FF88>custom music</color>",
            "Mode: <color=#DDDD66>loading custom music - vanilla plays meanwhile</color>",
            "Mode: <color=#FF8888>music error - vanilla playing (see log)</color>",
            "Mode: <color=#FF9966>menu music is set to None - change it in Settings</color>",
            "Mode: <color=#FF9966>stopped - press Play or Use vanilla music</color>",
            "Mode: <color=#FFC8F0>previewing</color>",
            "Moderation",
            "Modes",
            "Monochrome",
            "Month/Day/Year (US)",
            "Moonlit",
            "More",
            "More ranked than not.",
            "More than 10",
            "More...",
            "Moss",
            "Most 5-0 sweeps carrying these cards (casual + ranked)",
            "Most Similar Player",
            "Most Stacked",
            "Most Used Cards",
            "Most similar players",
            "Most wins carrying these cards (casual + ranked)",
            "Most-played ranked opponents",
            "Mouse",
            ...
            "Moustache",
            "Mouth: a distinguished handlebar. Equip in the Character editor.",
            "Mouth: community cosmetic. Ships with the next mod update; equip in the Character editor.",
            "Mouth: sewn shut. Equip in the Character editor.",
            "Move spd",
            "Movement & shield tech",
            "Multiplayer",
            "Music",
            "Music credit toast: <color=#88FF88>ON</color>",
            "Music credit toast: <color=#FF9966>OFF</color>",
            "Music download failed - press Retry",
            "Music download is rate-limited - waiting to retry",
            "Music failed to load ({0}) — play the track to retry",
            "Music files are missing - reinstall the mod through your mod manager",
            "Music files failed verification - press Retry",
            "Music files not installed",
            "Mustard",
            "Mute From Message...",
            "Mute Player...",
            "Mute a player in chat - find the player",
            ...
            "My Stats",
            "My collection is public: <color=#888>...</color>",
            "My collection is public: <color=#88FF88>ON</color>",
            "My collection is public: <color=#FF9966>OFF</color>",
            "NETWORK",
            "NEW",
            "NEW\u0004pack open",
            "NOT LIVE YET - your view starts at the next round",
            "NOT RECORDED",
            "Nah",
            "Name",
            "Name Styles",
            "Name styling",
            "Near-black blocks on a black background — max contrast.",
            "Near-black volcanic glass. Disappears into the night.",
            "Nemesis Comparison",
            "Nemesis Comparison - who beats this group most",
            "Neon Cyan",
            "Neon Lime",
            "Neon Orange",
            "Neon Pink",
            "Neon Toxic",
            "Neon Violet",
            "Net rating vs them: {0}",
            "Netcode & Photon",
            "New",
            "New here? The glowing Search Ranked button up top queues you for your first match.",
            "New mail from {0}: {1}",
            "New message",
            "Newer >",
            "Newest Cosmetics",
            "Next",
            "Next >",
            "Next tournament match vs {0} in {1}{2}",
            "Next tournament match vs {0} soon{1}",
            "Nice shot!",
            "Night City",
            "Night Park",
            ...
            "OFF",
            "ONE CONDITIONAL HIT",
            "ONE GAME, ONE SIGNED REPORT",
            "OOB bullet despawn",
            "OPEN",
            "OPPONENT'S CLIENT",
            "OTHER",
            "ObjectPool init clamp (in-match)",
            "Obsidian",
            "Ocean Gradient",
            ...
            "Olive",
            "On Fire",
            "On-screen pop-ups for incoming chat and XP/level notifications. The chat log on the Home tab updates either way.",
            "One copy, full flight, bars on a log scale. The mod pins every eligible Grow bullet to the same 120 FPS growth clock: about x3.1.",
            "One free pack a day (resets at midnight UTC) - also /daily in Discord",
            "One of the recipients could not be found.",
            ...
            "Only the host decides this.",
            "Open",
            "Open Packs",
            "Open Report Form",
            "Open Tier List Folder",
            "Open Upload Folder",
            "Open a pack",
            "Open for {0} gold",
            "Open for {0} shards",
            "Open the Info library",
            "Open today's free pack",
            "Open with gold",
            "Open with shards",
            "Opening draws:",
            ...
            "Opponent Blocks",
            "Opponent Hit Rate",
            "Opponent Variety % (unique opponents / series)",
            "Opponent failed to join — returning to menu. Requeue when ready.",
            "Opponent hasn't connected yet — hang tight...",
            ...
            "Other",
            "Other\u0004report reason",
            "Other players can pull, collect and trade a card of you showing your name, rank title, rating and ranked record - the same things the leaderboard shows. Turn this off and no new copies are printed; copies already pulled stay in their owners' collections.",
            "Overall Series: {0}",
            ...
            "POOL\u0004pc.stat.pool",
            "PREVIEW · NOT A PRINT",
            "PREVIEW · NOT A PRINT\u0004pc.preview_footer",
            "Pacifist",
            "Pack",
            "Pack opened - {0} new cards",
            "Pack {0} of {1} ({2}) - {3}",
            "Packs waiting to be opened",
            "Page {0} of {1}",
            "Page {0}/{1}",
            "Pale icy blue, like a winter sky.",
            "Pale luminous yellow name with a matching glow halo. Mimics the classic Steam-name color trick.",
            "Pale mint blocks on a cool dim backdrop.",
            "Pale silver-blue walls over a pitch-black night, with a faint star glint.",
            "Pale spearmint body color.",
            "Party Crasher",
            "Party Crown",
            "Pass Rate",
            "Pass rate (offered but not taken)",
            "Pass%",
            "Password",
            "Password (share it with friends)",
            ...
            "Performance master switch — flips ALL the patches below at once.",
            "Phoenix",
            "Phoenix Flame",
            "Phoneix Gaze",
            "Pick",
            "Pick Your Start Times (as many as you like)",
            "Pick Your Start Times <color=#888>(multi-select, required to sign up)</color>  <color=#7FE8C3>best time: {0}/{1} agreed</color>",
            "Pick a card! (left/right + jump)",
            "Pick at least one start time first",
            "Picks",
            "Pine",
            "Ping",
            ...
            "Pool #{0} | Ed. {1} | {2}",
            "Porcelain",
            "Portal session failed - are you signed in to Steam?",
            "Posted to Discord - good luck!",
            "Precision shooter",
            "Precision-stepped poses, one servo at a time. Dancing locks your controls for the duration.",
            ...
            "Preparing your card picture...",
            "Preset {0}",
            "Press Enable on the RANKED row first - the RLFP ping is only for ranked matches.",
            "Press Esc to leave",
            "Preview",
            "Preview art isn't downloaded yet - try again in a minute.",
            "Preview logs",
            "Preview: {0}",
            "Preview: {0}  <color=#888>({1})</color>",
            "Previews load at the main menu",
            "Previous track is not loaded yet — use Previous at the main menu",
            "Price",
            "Prices changed - refreshing them first",
            "Print {0}",
            "Prismatic",
            "Prismatic Wake",
            "Pristine Perfection",
            ...
            "Prizes",
            "Prizes & Rules",
            "Prizes are announced when signups open.",
            "Pronoun title.",
            "Pure aggression",
            "Pure greyscale — minimum visual distraction.",
            "Purple Cursor",
            "Purple Name",
            "Purple-black shadow trail. Feels wrong in the best way.",
            "Q (hold) - quick-chat wheel, release to send",
            "QF A",
            "QF B",
            "QF C",
            "QF D",
            "QShoot",
            "QUICK SHOTS INSIDE THE 0.35 SECOND WINDOW",
            "Queue games (ranked 1v1, and 2v2 / 1v2 auto-queue) deal everyone the same cards when every player in the room has this on. Applies from your next game.",
            "Quick Reload main",
            "Quick chat",
            "Quick chat is on cooldown - one message every couple of seconds.",
            "Quick chat works once you are in a game with your character spawned.",
            "RANK",
            "RANK\u0004pc.stat.rank",
            "RANK TIERS AND REWARD MULTIPLIERS",
            "RANKED",
            "RANKED - Recording",
            "RANKED: OFF",
            "RANKED: ON",
            ...
            "Ranked: OFF",
            "Ranked: ON",
            "Rapid-fire shoulder shake with pulsing arms. Dancing locks your controls for the duration.",
            "Rare",
            "Rare\u0004card rarity",
            "Rare pulls may be posted to the Discord announcements channel with your name.",
            "Rarest Hand",
            "Rarity",
            "Rates",
            "Rating",
            "Rating History  ({0} Elo, {1} rating updates)",
            "Rating {0} | peak {1}",
            "Ratings & Rewards",
            "Ratings (Glicko-2)",
            "Ratings, gold and the series result all settle when someone takes their 2nd game.",
            "Reach 1700 rating in ranked (1v1 or 2v2)",
            "Reach 1980 rating in ranked (1v1 or 2v2)",
            "Reach 2330 rating in ranked (1v1 or 2v2)",
            "Reading a card",
            "Ready Up",
            "Ready-up failed — retrying search",
            "Reason",
            "Reason (optional)",
            "Reborn after defeat",
            "Recent Async Tournaments",
            "Recent Ranked Series",
            "Recent Sync Tournaments",
            "Reconnect suppressed (broadcast identity)",
            "Reconnect to Match",
            "Record removal failed: {0}",
            "Record removed.",
            "Records",
            "Red Cursor",
            "Red Name",
            "Redrawn from Spirit's diagram: Conditional damage never Refreshes twice in a row.",
            "Refresh",
            "Refresh?",
            "Refreshing too fast - give it a sec",
            "Regen",
            "Region Time",
            "Region distribution",
            "Regular",
            ...
            "Render your name at 130% size.",
            "Render your name at 160% size.",
            "Render your name at 80% size.",
            "Rendering card art {0}/{1}...",
            "Reply",
            "Reply all",
            "Reply all is not available for this message.",
            "Reply to all",
            "Report",
            "Report a bug",
            "Report approved for recovery - an ordered replay is still required.",
            "Report dismissed for good.",
            ...
            "Requeue",
            "Reset the window",
            "Restore the vanilla random map color rotation.",
            "Resuming series at {0}-{1}",
            "Retry",
            "Return to menu",
            "Revenue",
            "Reverse Series...",
            "Reverse a ranked 1v1 series",
            "Reverse {0}",
            "Revoke",
            "Revoke Artist...",
            "Revoke Translator...",
            "Revoke consent",
            "Revoke which alert?",
            "Revoke which translation role?",
            "Rich forest-green body color.",
            "Rich purple blocks on a dim cool backdrop.",
            "Rise from the Ashes",
            "Rising Star",
            "Riveted steel great-helm with a T-slit visor.",
            "Rolling DPS (15 s window)",
            "Rolling block % (15 s window)",
            "Rolling hit % (15 s window)",
            "Room rules: friendly fire OFF",
            "Room rules: friendly fire OFF, same cards for everyone",
            "Room rules: same cards for everyone",
            "Room settings did not match — left the room",
            "Rose",
            "Rose Quartz",
            "Rosetta",
            "Royal",
            "Royal Gradient",
            "Royal purple drifting into pale cyan. Two-color gradient.",
            "Royal violet body color.",
            "S p a c e d",
            "SALES OPEN",
            "SERIES COMPLETE {0}!",
            "SERVER",
            ...
            "SHIELD EDGE BOUNCE",
            "SHIFT",
            "SHIFT - cycle your equipped map skins",
            "SHIPS IN A RELEASE",
            "SHOP",
            "SID'S COMPETITIVE ROUNDS",
            "SIGNAL, FLAG, HUMAN REVIEW",
            "SIGNED",
            "SIGNED\u0004pc.signed",
            "SIGNED REPORT",
            "SPACE",
            "SPACE (hold, in a lobby) - ready up / join",
            "SPECTATING",
            "SPECTATOR",
            "SYNC (weekly)",
            "Sadness",
            ...
            "Score",
            "Score progression",
            "Score race (points per game)",
            "Screen shake: <color={0}>{1}</color>",
            "Search Random",
            "Search Ranked",
            "Search cards",
            "Search players",
            "Search...",
            "Searching for ranked match...",
            "Searching... {0}m {1}s  +/-{2}",
            "Searching... {0}s  +/-{1}",
            "Searing electric-green body color.",
            "Searing-lime neon name with a soft glow halo. Visible to everyone; modded players also see the glow.",
            "Seasonal Spring",
            "Secure connection unavailable - signed-in features are disabled this session.",
            "Select 2-12 players (left) to see who beats each of them most.",
            "Select 2-12 players to find their common nemesis.",
            "Select players (left) to chart {0}.",
            "Select players (left) to compare {0}.",
            "Select up to 12 players",
            "Selected {0}/{1}  -  click a card to add/remove",
            "Selected {0}/{1}  -  click a player to add/remove",
            "Self-Death %",
            "Self-Inflicted Deaths % (boundary + own bullet)",
            ...
            "Series Score: {0} - {1}",
            "Series complete: {0}",
            "Series streak: them x{0}",
            "Series streak: you x{0}",
            "Series {0}  vs {1}  (in progress)",
            "Series {0} (in progress)",
            "Series {0} {1}",
            "Series {0} {1}  vs {2}",
            "Series {0}-{1}",
            "Series: {0}",
            ...
            "Session series ({0})",
            "Session {0}-{1}",
            "Session: {0} games, series {1}-{2}",
            "Session: {0} series",
            "Set Active",
            "Set RefreshValid to false",
            "Set RefreshValid to true",
            "Set summary",
            "Settings",
            "Severity:",
            "Shades for those who want to show that they are the true genius of the battlefield",
            "She/her",
            "Shifts through the spectrum as you move. Pure show-off.",
            "Shock Shades",
            "Shoot",
            "Shop",
            "Shop & cosmetics",
            "Shop Sales",
            "Shop listing name - {0}",
            "Shop listing name only - the Music tab and now-playing keep the compiled album name (max 64 chars)",
            "Shop sales",
            "Shortest Game",
            "Shots",
            ...
            "Show Gold",
            "Show inactive players (90d+): <color=#88FF88>ON</color>",
            "Show inactive players (90d+): <color=#FF9966>OFF</color>",
            "Showing {0} of {1}",
            "Showing: Elo",
            "Showing: {0}",
            "Shows a small bottom-left credit line naming the track and artist whenever a custom song starts.",
            "Shows community chat in the corner while you play. Press T to type a reply, or M in game to cycle normal / pinned / muted.",
            ...
            "Sign-in still pending - try again in a moment.",
            "Signed up for tournament",
            "Signup failed",
            "Signups",
            "Silence only: every other Silence produces a Refresh",
            "Silent Assassin",
            "Silly Drill",
            "Since first",
            "Sinister Smile",
            "Size",
            "Skip MenuControllerHandler.Update during an active match.",
            "Sky",
            "Slate",
            "Sleek black body color.",
            "Slow connection — still trying to join the match...",
            "SmAlLcApS",
            "Smaller Name",
            "Smart Specs",
            "Smoking",
            ...
            "Soda Helm",
            "Soft Slate",
            "Soft pastel lavender — minimum contrast.",
            "Soft pastel violet body color.",
            "Soft pink body color.",
            "Soft pink shimmer. Deceptively innocent.",
            ...
            "Solo Leaderboard",
            "Solo extra pick",
            "Solo extra pick (host): OFF",
            "Solo extra pick (host): ON",
            "Solo {0}W/{1}L",
            "Sorry!",
            "Sort:",
            "Sovereign",
            ...
            "Spam",
            "Sparks",
            "Speacial eyes for the feline enthused",
            "Spectate is settling - try again in a moment.",
            "Spectating",
            ...
            "Start Game ({0}/{1})",
            "Start Here",
            "Start unlocks in {0}s (settings changed)",
            "Starts: <color=#FFDE88>{0}</color>",
            "Stats still loading - try again in a moment.",
            "Status: <color=#88FF88>Allowed</color> - match data and linking are active.",
            "Status: <color=#DDDD66>Unset</color> - the consent prompt will appear on next launch.",
            "Status: <color=#FF9966>Denied</color> - mod runs offline. No data leaves your machine.",
            "Steam ID copied to clipboard",
            "Steam ID not ready yet — try again in a few seconds",
            "Steam identity is not available yet",
            "Steam identity not ready yet",
            "Steam session not accepted — queue polling stopped; the server will clear your seat shortly. Try again in a moment.",
            "Steam sign-in is required to view session reports",
            "Steam sign-in still pending - try again in a moment.",
            "Steel Gradient",
            "Still joining - one moment...",
            "Still leaving the 1v2 queue — try again in a moment.",
            "Still leaving the 2v2 queue — try again in a moment.",
            "Still leaving the FFA queue — try again in a moment.",
            "Still leaving the queue — try again in a moment.",
            "Still leaving — try again in a moment.",
            "Still opening - checking again shortly",
            "Still waiting for the server to record your pack - checking again shortly",
            "Stitched Grin",
            "Stock",
            "Stop",
            "Stop Avoiding in Ranked",
            "Stop spectating first (Esc).",
            "Stop spectating?",
            "Stopped searching",
            "Storm Halo",
            "Strike",
            "Strike through your name. Stackable with other name styles.",
            "Stun null-guard",
            "StunPlayer null-guard — stops NRE spam when a player is destroyed mid-stun.",
            "Subject",
            "Submit",
            "Submit Report",
            "Submitting...",
            ...
            "Sure? Discard dupes",
            "Sustained Power",
            "Swallow RayHitBulletSound NREs from destroyed parents.",
            "Swallow ScreenEdgeBounce NREs from destroyed bullets.",
            "Sway and wave to the crowd. Play it between rounds with the E wheel.",
            "Sweat is just XP in liquid form.",
            "Sweaty",
            "Sweden",
            "Sweeps: <color=#00FF00>5-0 x{0}</color>  <color=#FF6666>0-5 x{1}</color>",
            "Sync (weekly)",
            "Sync Champion",
            "Sync Finalist",
            "Synchronizing - viewing begins next battle",
            "Syncing...",
            "System notices cannot be reported.",
            "T - open in-game chat",
            "TAB",
            "TAB (hold, in a match) - live scoreboard",
            "TABLE OF DAMAGE INTERACTIONS",
            ...
            "TOURNAMENT STARTING - matches are being created, hold tight...",
            "TOURNAMENT STARTS IN {0} - stay in ROUNDS at the main menu!",
            "Tag Team Sweep",
            "Take 2nd place in a live (sync) tournament",
            "Take 2nd place in an async tournament",
            "Taken",
            "Tan",
            "Tank",
            "Target Bounce main",
            ...
            "Team 2: blue",
            "Team {0}",
            "Team: <color=#88AAFF>2</color>",
            "Team: <color=#FFB347>1</color>",
            "Team: Any",
            "Teams will rebalance next match!",
            "Tell the moderators why. The message is attached to the report as it was sent.",
            "Thanks for testing the mod during beta. Free, removed after beta ends.",
            "Thanks!",
            "That FFA lobby is private — enter its password.",
            ...
            "That game is no longer live.",
            "That pack is not available any more",
            "That pack is still opening - hold on",
            "That pack purchase never went through - nothing was charged",
            "That pack was voided - the series it came from was reversed",
            "That player could not be found.",
            "That {0} lobby is private — enter its password.",
            "That's you - pick someone else.",
            "The Bounce",
            "The Challenger",
            "The Comeback Kid",
            "The Cryptid",
            ...
            "The Wave",
            "The bot & check-ins",
            "The cutoff is scored points, never a clock. Either lock condition closes the window.",
            "The exact green a poison tick flashes on its victim.",
            "The expression of a true warrior going into battle. Takes up the mouth slot",
            ...
            "This release only ships a zip — opening the releases page to update manually",
            ...
            "Tie",
            "Tier",
            "Time to show them who is the coolest dude around! A pair of glasses that takes up the eye slot",
            "Time's up - {0} picked automatically.",
            "Timeline",
            "Times Offered",
            "Times Picked",
            "Times offered",
            "Times picked (all players)",
            "Times picked (ranked games only)",
            "Timezone:",
            "Titan",
            "Titles",
            ...
            "To pick the best server region for a match, the mod measures your ping to each Photon region and sends the result to the server, where it is kept for at most one hour.",
            "To: {0}",
            "To: {0} and {1} others",
            "Today's free pack is already claimed",
            "Too many messages - try again in {0} hours.",
            "Too many messages - try again in {0} minutes.",
            "Too many messages - try again in {0} seconds.",
            ...
            "Type !link CODE in Discord",
            "Typing channel",
            "Typing: {0}  (Alt to change)",
            "UNC",
            "UNC\u0004pc.band_short.uncommon",
            "UNCOMMON",
            "UNCOMMON\u0004pc.band.uncommon",
            "Umber",
            "Unavailable until the game restarts",
            "Unban",
            "Unblock",
            "Unblocked {0}.",
            "Unclosed quote — usage: /report \"Multi Word Name\" [reason]",
            "Uncommon",
            ...
            "Wisps of grey smoke drift off your body.",
            "Wisps of living shadow crown your head. ANIMATED.",
            "Won",
            "Worn by those who climbed the mountain.",
            "Worst Cards",
            "Wrap your name in <b>bold</b>. Stackable with other name styles.",
            "Wrap your name in <i>italic</i>. Stackable with other name styles.",
            ...
            "Yin & Yang",
            "You",
            "You are muted - mail is unavailable while the mute lasts.",
            "You can't kick yourself.",
            "You cannot block yourself.",
            "You don't own any dances yet - check the Shop's DANCES section!",
            "You should join Competitive Rounds, it's a discord community",
            "You show up.",
            "You're in a live {0} game — finish or leave it first.",
            "YouTube",
            "Your 2v2 lobby is starting — Ready Up in the 2v2 tab (F5)!",
            "Your Block Rate",
            "Your Blocks",
            "Your FFA is already starting — leave it first if you meant to switch.",
            "Your FFA lobby closed.",
            "Your FFA match continued without you - you've been removed from it.",
            "Your Hit Rate",
            "Your Player Cards settings changed elsewhere - refreshed, try again",
            "Your block list is full - unblock someone first.",
            "Your card can show your in-game character - the same body, face, colour and effect you play with, drawn by this PC and sent once. Until this PC has sent it, your card shows your Steam profile picture. Set it to None and your card shows the plain card emblem instead.",
            "Your game is dropping frames (worst {0} ms)",
            "Your last pack ({0}) - {1}",
            "Your match (R{0}{1}): vs <color=#FFDE88>{2}</color>",
            "Your message was removed and you are muted for {0} minutes (auto-moderation).",
            "Your name fades from warm amber into deep pink.",
            "Your no-show penalty: <color=#FFCC44>{0}%</color>",
            ...
            "lost {0} of {1}",
            "macro-pace input windows",
            "match data unavailable",
            "match goes live",
            "mod",
            "mod-issued",
            "mod-issued: queue / 2v2 / tournament / ranked FFA = ranked",
            "music album",
            "nametag",
            "no - casual",
            "no - stop",
            "no build recorded for these games",
            "no card data",
            "no cards recorded",
            "no data",
            "no data yet",
            "no debt, no double buys",
            "no direct PC link",
            "no opponent has taken 3+ series from them",
            "no profit at these odds",
            "no rating or gold recorded for this set",
            "nobody - your screen only, never networked",
            "nobody yet",
            "none yet",
            "not blocking: 51 damage + return impulse",
            "not enough data (4+ picks)",
            "not recorded (older block format)",
            "not recorded for this mode",
            "nothing",
            "nothing - vanilla has no surface for them",
            "now: <b>{0}</b>",
            "on the boards and in chat",
            "one +24h extension",
            "one 0.3s block window",
            "one 2v2 rating outcome",
            "one active, or multi-equip",
            "one color at a time",
            "one font at a time",
            "one glow at a time - modded players only",
            "one present: absent player forfeits",
            "one size at a time",
            "one typeface at a time - modded players only",
            "online, data on, fighter",
            "only if it is 1-1",
            "opp n/a",
            "opponent",
            "opponent has run",
            "optional extra opening pick",
            "otherwise: score / check-in / no-show tiebreak",
            "own bullets judge hits",
            "player color",
            "player effect",
            "point + release E to dance",
            "point + release Q to send",
            "point lost",
            "point won",
            "press",
            "private",
            "pts",
            "ranked 1v1 series vs anyone in the selection, minimum 5 series",
            "ranked or casual",
            "rare",
            "rating updates ->",
            "recent: worst frame {0} ms  resends {1}  discards {2}",
            "recently online",
            "recordable setting?",
            "recorded once",
            "regular (converged)",
            "replica age est. n/a",
            "replica age est. {0} ms one-way (peer-reported input)",
            "report version {0} - some panels may be missing",
            "reset if LB wins",
            "rolled out: {0}",
            "room code",
            "room type?",
            ...
            "series created",
            "series ends",
            "short-match farming pattern",
            "showing the newest {0} games of this sitting",
            "showing the newest {0} games of this sitting ({1} not shown)",
            "showing {0} of {1}",
            "solo: the outer-left point",
            "stackable",
            "sudden death",
            "the base award scales with your opponent's tier; podium and sweep bonuses can add more",
            "the full art",
            "the host",
            "the mod?",
            "the one automatic penalty",
            "the styled name - minus glow and typeface",
            "title",
            "touch wall while holding into it",
            "tracks the whole game",
            "trail",
            "triggers",
            "two players, one side",
            "two teams of two",
            "uncommon",
            "unknown",
            "unknown path",
            ...
            "utility",
            "vs {0}",
            "vs {0}: first game this session",
            "vs {0}: {1}-{2} this session",
            "w/ {0}",
            "w/ {0}   vs {1}",
            "waiting {0}s",
            "wall touch refreshes all jumps unless you jumped within the last 0.15s",
            "watching",
            "window over - cooldown keeps counting from the press",
            "with exact evidence",
            "yes",
            "yesterday",
            "you",
            "your aura",
            "your color",
            "your stake plus profit by the odds - short-odds wins are lightly taxed",
            "your trail",
            "{0:N0} XP",
            "{0}  {1}%  ({2} picks)",
            "{0} ({1} ratings, {2} listeners)",
            "{0} + {1} more",
            "{0} - {1} games - {2} played",
            "{0} / {1} unlocked",
            "{0} <b>won</b> {1}-{2}",
            ...
            "{0} GOT HALF A POINT",
            "{0} Hit Rate",
            "{0} active players (90d)",
            "{0} and {1} more",
            "{0} can now translate {1}.",
            "{0} cards",
            "{0} d ago",
            "{0} days ago",
            "{0} dps",
            "{0} elo",
            "{0} games    {1}W - {2}L    {3}",
            "{0} games  {1} wins  Top3 {2}%  Avg place {3}",
            "{0} gold",
            "{0} h ago",
            "{0} half-point events",
            "{0} item(s), {1} cop(ies) out there.",
            "{0} keys/s",
            "{0} kills   {1} dmg",
            "{0} lost {1}",
            "{0} matches ({1}W / {2}L)  WR: {3}%",
            "{0} min ago",
            "{0} months ago",
            "{0} of {1} left",
            "{0} of {1} paid packs today - {2} cards each",
            "{0} of {1} players",
            "{0} opening picks",
            "{0} paid packs today - no daily limit on this account - {1} cards each",
            "{0} picked {1}",
            "{0} player online now",
            "{0} players",
            ...
            "{0} years ago",
            "{0}-card draw",
            "{0}-player FFA starting in 5 seconds!",
            "{0}: <color=#888>(not bound)</color>",
            "{0}: <color=#FF9966>OFF</color>",
            "{0}: rating {1}",
            "{0}: rating {1} -> {2} ({3})",
            "{0}: {1} gold",
            "{0}h ago",
            "{0}ms opp (peer-reported)",
        };
    }
}
