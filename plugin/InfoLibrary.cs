...
namespace CompetitiveRounds
{
    ...
    internal static class InfoLibrary
    {
        ...
        private static readonly Color CAT_CARDS = new Color(1f, 0.78f, 0.36f);
...
- The pool line under the pack buttons tells you how many players the current snapshot holds and when it was taken.");

        private static string CardsPacks => I18n.Tr(@"<color=#FFD94D><b>GETTING PACKS</b></color>
...
- If the player deletes their data, every card of them is removed from every binder.");
        ...
        internal static Category[] Categories => _cats ?? (_cats = new[]
        {
            ...
            new Category { Title = () => I18n.Tr("Player Cards"), Color = CAT_CARDS, Articles = new[]
            {
                new Article { Key = "cards",          Title = () => I18n.Tr("Player Cards"),            Body = () => CardsIntro + "\n\n" + CardsPacks },
                new Article { Key = "cards-face",     Title = () => I18n.Tr("Reading a card"),          Body = () => CardsFace },
                new Article { Key = "cards-pictures", Title = () => I18n.Tr("Card pictures & settings"), Body = () => CardsPictures },
            }},
        });
