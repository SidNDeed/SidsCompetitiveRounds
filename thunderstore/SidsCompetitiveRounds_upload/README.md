...
- **47 achievements** (100-1000g by difficulty, several unlock exclusive titles) — from card-build challenges (5-0 with Barrage, two Glass Cannons...) to marathon streaks (100+ casual wins in a row) and FFA feats (100 kills in one game), with retroactive grants from your existing match history.
