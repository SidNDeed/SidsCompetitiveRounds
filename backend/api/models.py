...
class Match(Base):
    ...
    # Release A W1: reporter-only network telemetry. Each report populates
    # exactly the authenticated reporter's p1/p2 seat; the other seat remains
    # NULL because this request contains no authenticated peer evidence. All
    # columns are nullable with no defaults so old reports remain
    # distinguishable from observed zeroes. Nothing here is public response
    # data or part of a match HMAC canonical.
    p1_net_writes = Column(Integer, nullable=True)
    p1_net_unchanged = Column(Integer, nullable=True)
    p1_net_move_raise_attempted = Column(Integer, nullable=True)
    p1_net_move_raise_accepted = Column(Integer, nullable=True)
    p1_net_resent_reliable = Column(Integer, nullable=True)
    p1_net_discarded = Column(Integer, nullable=True)
    p1_net_crc_loss = Column(Integer, nullable=True)
    p1_net_queued_out_max = Column(Integer, nullable=True)
    p1_net_queued_in_max = Column(Integer, nullable=True)
    p1_net_fragment_cmds = Column(Integer, nullable=True)
    p1_net_view_update_faults = Column(Integer, nullable=True)
    p1_net_hitch50 = Column(Integer, nullable=True)
    p1_net_hitch200 = Column(Integer, nullable=True)
    p1_net_worst_frame_ms = Column(Integer, nullable=True)
    p1_obs_gap300 = Column(Integer, nullable=True)
    p1_obs_gap750 = Column(Integer, nullable=True)
    p1_obs_gap1500 = Column(Integer, nullable=True)
    p1_obs_max_gap_ms = Column(Integer, nullable=True)
    p1_obs_excess150 = Column(Integer, nullable=True)
    p1_obs_max_excess_ms = Column(Integer, nullable=True)
    p1_obs_payload_equal_gaps = Column(Integer, nullable=True)
    p1_obs_receiver_frame_gaps = Column(Integer, nullable=True)
    p1_obs_phoenix_intervals = Column(Integer, nullable=True)
    p1_obs_batches = Column(Integer, nullable=True)
    p1_net_worst_frame_tags = Column(String(48), nullable=True)
    p2_net_writes = Column(Integer, nullable=True)
    p2_net_unchanged = Column(Integer, nullable=True)
    p2_net_move_raise_attempted = Column(Integer, nullable=True)
    p2_net_move_raise_accepted = Column(Integer, nullable=True)
    p2_net_resent_reliable = Column(Integer, nullable=True)
    p2_net_discarded = Column(Integer, nullable=True)
    p2_net_crc_loss = Column(Integer, nullable=True)
    p2_net_queued_out_max = Column(Integer, nullable=True)
    p2_net_queued_in_max = Column(Integer, nullable=True)
    p2_net_fragment_cmds = Column(Integer, nullable=True)
    p2_net_view_update_faults = Column(Integer, nullable=True)
    p2_net_hitch50 = Column(Integer, nullable=True)
    p2_net_hitch200 = Column(Integer, nullable=True)
    p2_net_worst_frame_ms = Column(Integer, nullable=True)
    p2_obs_gap300 = Column(Integer, nullable=True)
    p2_obs_gap750 = Column(Integer, nullable=True)
    p2_obs_gap1500 = Column(Integer, nullable=True)
    p2_obs_max_gap_ms = Column(Integer, nullable=True)
    p2_obs_excess150 = Column(Integer, nullable=True)
    p2_obs_max_excess_ms = Column(Integer, nullable=True)
    p2_obs_payload_equal_gaps = Column(Integer, nullable=True)
    p2_obs_receiver_frame_gaps = Column(Integer, nullable=True)
    p2_obs_phoenix_intervals = Column(Integer, nullable=True)
    p2_obs_batches = Column(Integer, nullable=True)
    p2_net_worst_frame_tags = Column(String(48), nullable=True)
